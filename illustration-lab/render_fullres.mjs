...
const OUT=`${SP}/raw15_full`; await mkdir(OUT,{recursive:true});
...
const PROMPT=(c)=>"Create a single original black-line drawing that closely matches the raw drawing style in the reference images. "+REFBLOCK+" Draw ONE object as a quick sketch on paper in the same spirit as the references — a simple invention sketch, not a clean doodle or clipart. Draw it in one quick pass with no corrections, like a doodle in the margin of a notebook, sitting a little off-center and a touch small on the page, with lots of blank paper around it. Draw: "+c+".\n\nImportant style rules:\n* Match the user's line quality: wobbly, blunt, uneven, slightly shaky lines with inconsistent thickness — use a thin, slightly scratchy pen with uneven pressure, some strokes faint or fading, NOT a bold confident marker.\n* Let lines overshoot and not quite meet at the corners; leave small gaps where the pen lifted; allow occasional retraced or doubled lines.\n* Keep the forms extremely simple, sparse, awkward, and direct; let proportions be clumsy, lopsided, and imperfect.\n* No shading, no color, no polished icon design, no smooth symmetry, no cute decorative embellishment.\n* On slightly grainy off-white notebook paper; make the page feel like a photographed or scanned sketch page.\n* Just barely legible — do not fully render or clean it up. No attempt to make it look good; a little ugly, lopsided, or wrong is correct.\n* No whole people or stick figures (a hand is fine). Any words should look hand-lettered, small, and slightly wobbly.";
const CONCEPTS=[
