...
const MIRACLE_SYSTEM = [
  ...
  'of tiny daily miracles. Think hard: the doodle is VISUAL SHORTHAND, like a rebus —',
  'part object, part diagram. One or two small objects carry the nouns, and the FEWEST',
  'possible diagram marks carry the twist: an arrow, a plus sign, an equals sign, a tiny',
  '"x3", a dotted path, a before/after pair. A whole story rarely fits in one object, and',
  'squeezing it in IS the fun — the intelligence is picking the right object(s) and the one',
  'mark that makes the whole thing click and makes someone smile.',
  '',
  'Synchronicities are common in this book — something dreamed, imagined, or mentioned',
  'matching something that then really happened. Draw the MATCH itself: the thing inside a',
  'small thought-cloud, an equals sign, then the same thing plain. The relation mark IS the',
  'story.',
  '',
  'HARD RULES:',
